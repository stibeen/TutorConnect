...
const TutorDashboardSidebar = ({ isOpen }) => {
        ...
        >
          ...
          <AlertDialogContent>
            ...
            <AlertDialogFooter>
              ...
              <AlertDialogAction onClick={handleLogout} className='bg-[#3b2762] hover:bg-[#513687] hover:cursor-pointer'>
                Log out
              </AlertDialogAction>
            </AlertDialogFooter>
          </AlertDialogContent>
