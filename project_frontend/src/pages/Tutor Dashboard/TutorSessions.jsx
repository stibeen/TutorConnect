...
import { TutorSessionsList } from "../../components/Tutor Dashboard/TutorSessionsList";
        ...
        <CardContent>
          <Tabs defaultValue="upcoming">
            ...
            <TabsContent value="upcoming" className="mt-4">
              <TutorSessionsList status="upcoming" bookings={bookings} />
            </TabsContent>
            <TabsContent value="completed" className="mt-4">
              <TutorSessionsList status="completed" bookings={bookings} />
            </TabsContent>
            <TabsContent value="cancelled" className="mt-4">
              <TutorSessionsList status="cancelled" bookings={bookings} />
            </TabsContent>
            <TabsContent value="requests" className="mt-4">
              <TutorSessionsList status="requests" bookings={bookings}/>
            </TabsContent>
          </Tabs>
        </CardContent>
      </Card>
