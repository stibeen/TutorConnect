...
const Notifications = () => {
  ...
  const filteredNotifications = notifications.filter((notification) => {
    ...
    if (filter === "sessions") return notification.type?.includes("booking");
    if (filter === "system")
      return [
        "payment_processed",
  ...
  // Get notification icon based on type (tutee specific)
  ...
  // Get notification action button (tutee specific)
  const getNotificationAction = (notification) => {
    const actions = {
      ...
      payment_processed: {
        ...
        href: `/payments/${notification.data?.paymentId || ""}`,
      },
      tutor_recommendation: {
        text: "View Profile",
        icon: <Search className="h-3 w-3" />,
        href: `/tutors/${notification.data?.tutorId || ""}`,
      },
      new_message: {
        text: "Read Message",
            ...
            {/* {notification.relatedUser && (
              <div className="flex items-center gap-1">
                ...
                <span className="text-xs text-muted-foreground">
                  {notification.relatedUser.name || "Tutor"}
                </span>
              </div>
            )} */}
          </div>
    ...
    <div className="flex flex-col gap-6 p-4 md:p-8">
      <Card className="border-1 border-[#3b2762]">
        <CardContent>
          ...
          <Tabs defaultValue="all" className="w-full" value={filter}>
              ...
              {filteredNotifications.filter((n) => n.type?.includes("booking"))
                ...
                <div className="flex flex-col items-center justify-center py-12 text-center">
                  ...
                  <h3 className="text-lg font-medium">
                    No session notifications
                  </h3>
                  <p className="text-muted-foreground mt-2">
                    You'll see session-related notifications here.
                  </p>
                </div>
              ) : (
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Updates about your tutoring sessions
                    </CardDescription>
                  </CardHeader>
            ...
            <TabsContent value="system" className="mt-6">
              {filteredNotifications.filter((n) =>
                ...
                <div className="flex flex-col items-center justify-center py-12 text-center">
                  ...
                  <p className="text-muted-foreground mt-2">
                    You'll see system updates and recommendations here.
                  </p>
                </div>
              ) : (
                <Card>
